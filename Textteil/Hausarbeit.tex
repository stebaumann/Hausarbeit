...
\documentclass[
    ...
    %captions=tablesignature,% Beschriftung von Tabellen unterhalb ausgeben
...
\usepackage{titlesec}
\titleformat{\chapter}
   {\normalfont\large\bfseries}{\thechapter\quad}{0cm}{}\titlespacing{\chapter}{0pt}{-30pt}{0pt}
\titleformat{\section}
...
\usepackage{tabularx}
\usepackage{enumitem}
%% Inhalts-, Abbildungs- und Tabellenverzeichnis anpassen
\usepackage{titletoc}
...
\usepackage{parskip} % Abstand zwischen Absätzen (6pt)
\setlength{\parskip}{6pt}
%% Schriftgröße: Speziell
\setkomafont{chapterentry}{\normalsize}					% Kapitel im Inhaltsverzeichnis
\setkomafont{descriptionlabel}{\normalsize}			% Listeneinträge
\setkomafont{captionlabel}{\small\bfseries}			% z.B. "Abbildung X.X:"
...
]{scrlayer-scrpage}										% z.B. "Abbildungsname"
%% Kopf- und Fußzeilen 
% Info: Einige Parameter bereits in "Pakete.tex" definiert
\pagestyle{scrheadings}
\renewcommand*{\chapterpagestyle}{scrheadings}	% Kopf- und Fußzeile auch auf Kapitelanfangsseiten
\renewcommand{\headfont}{\small}						% Schriftart der Kopfzeile
\renewcommand*{\chapterheadstartvskip}{\vspace*{0.0\baselineskip}}% Abstand einstellen
%% Kopfzeile
\ihead{\headmark}					% Kopfzeile Links: Titel des aktuellen Kapitels
\chead{}								% Kopfzeile Mitte: Leer (standardmäßig Titel)
%\ohead{\pagemark}					% Kopfzeile Rechts: Seitenzahl (wird in Hauptdatei gesetzt)
%\ohead{\includegraphics[scale=0.2]{\logo}}			% Kopfzeile Rechts: Grafik einbinden
\setheadsepline[text]{0.4pt} 					% Trennlinie unter Kopfzeile
\setlength{\headheight}{1.1\baselineskip}				% behebt Warnung von scrpage2

%% Fußzeile
%\ifoot{}									% Fußzeile Links: -
\cfoot{\pagemark}									% Fußzeile Mitte: Leer (standardmäßig Seitenzahl)
...
\begin{figure}[!h]
	...
	\vspace{6pt}
	\centering
	\includegraphics[scale=0.30]			  {Trainingsfunktiony1_Lösung}
	\vspace{6pt}
...
\begin{minipage}{\textwidth}	
	\includepdf[page=1,scale=0.90, pagecommand={}]{hausarbeit_py.pdf}
	%\fbox{\includegraphics[width=1\textwidth]{test.pdf}}
\end{minipage}
\includepdf[page=2-17,scale=0.90, pagecommand={}]{hausarbeit_py.pdf}
\section{Python-Programm (UnitTest)}
\begin{minipage}{\textwidth}	
	\includepdf[page=1,scale=0.90, pagecommand={}]{hausarbeit_test.pdf}
	%\fbox{\includegraphics[width=1\textwidth]{test.pdf}}
\end{minipage}
\includepdf[page=2-3,scale=0.90, pagecommand={}]{hausarbeit_test.pdf}
